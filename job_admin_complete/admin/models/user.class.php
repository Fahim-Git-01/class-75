...
class User {
    ...
    public function create($data) {
        ...
        if ($c->num_rows > 0) return ['ok'=>false,'msg'=>'এই Email ইতোমধ্যে registered!'];
        ...
        return $s->execute()
            ? ['ok'=>true, 'msg'=>'User সফলভাবে তৈরি হয়েছে!']
    ...
    public function update($id, $data) {
        ...
        $c->execute(); $c->store_result();
        if ($c->num_rows > 0) return ['ok'=>false,'msg'=>'এই Email অন্য user ব্যবহার করছে!'];
    ...
    public function delete($id) {
        ...
        $s->bind_param("i", $id);
        return $s->execute()
            ? ['ok'=>true, 'msg'=>'User মুছে ফেলা হয়েছে!']
            : ['ok'=>false,'msg'=>'Error: '.$s->error];
    }
