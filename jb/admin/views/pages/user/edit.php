...
if (isset($_POST['btn_update'])) {
    ...
    if (empty($data['full_name'])||empty($data['email'])) {
        $msg='Name and Email '; $msgType='warning';
    } elseif (!empty($data['password']) && $data['password']!==$_POST['conf_pass']) {
        $msg='New Password dose not match'; $msgType='warning';
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form method="POST">
            ...
            <hr><p class="text-muted small"><i class="mdi mdi-information-outline"></i> </p>
            <div class="form-group row">
              <label class="col-sm-3 col-form-label">New Password</label>
              <div class="col-sm-9"><input type="password" class="form-control" name="new_pass"></div>
            </div>
            <div class="form-group row">
